...
class ProductsExcel{
  static Future<void> generateProductsExcel(List<Map<String, dynamic>> products, String customerName) async {
    ...
    try {
      ...
      final path = '${output!.path}/products_${customerName}_${DateFormat('yyyyMMdd_HHmmss').format(DateTime.now())}.xlsx';
