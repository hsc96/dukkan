      ...
      pw.Page(
        build: (pw.Context context) => pw.Column(
          children: [
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('Teklif No: $quoteNumber', style: pw.TextStyle(fontSize: 12, font: ttf)),
                    pw.Text('Teklif Tarihi: ${DateFormat('dd MMMM yyyy', 'tr_TR').format(quoteDate)}', style: pw.TextStyle(fontSize: 12, font: ttf)),
                  ],
                ),
              ],
            ),
            ...
            pw.SizedBox(height: 16),
            pw.Text('Yalnız: [Tutarın yazı ile yazılmış hali]', style: pw.TextStyle(fontSize: 12, font: ttf)),
            pw.SizedBox(height: 16),
            pw.Row(
              children: [
                pw.Expanded(child: pw.Text('TESLİM TARİHİ: $deliveryDate', style: pw.TextStyle(fontSize: 12, font: ttf))),
                pw.Expanded(child: pw.Text('MÜŞTERİ ONAYI: ', style: pw.TextStyle(fontSize: 12, font: ttf))),
              ],
            ),
          ],
        ),
